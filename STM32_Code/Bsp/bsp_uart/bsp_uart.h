...
#define USART_REC_LEN  			18// 18  25	//定义最大字节数 100
...
#define USART4_DR_Base  0x40004C04		// 0x40004C00 + 0x04 = 0x40004C04   串口1发送寄存器地址
 ...
 void UART4_NVIC_Configuration(void);//接收中断设置函数
 void UART5_NVIC_Configuration(void);//接收中断设置函数
 void USART6_NVIC_Configuration(void);//接收中断设置函数
