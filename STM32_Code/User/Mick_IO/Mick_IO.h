...
#define LED1_ON    GPIO_ResetBits(GPIOF,GPIO_Pin_13)    
#define LED1_OFF   GPIO_SetBits(GPIOF,GPIO_Pin_13)  
...
#define LED3_ON    GPIO_ResetBits(GPIOF,GPIO_Pin_15)    
#define LED3_OFF   GPIO_SetBits(GPIOF,GPIO_Pin_15)   
